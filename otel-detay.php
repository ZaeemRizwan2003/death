        ...
        <div class="wrapper">
            ...
            <span class="magnific-gallery">
                ...
                foreach ($pictures as $picture) {
                    ...
                    ?>
                    <a href="data/hotel/pictures/<?= $picture->big_picture ?>" <?php if ($i == 1) {
                        echo 'class="btn_photos"';
                    } ?>
                        title="<?= $content ?>" data-effect="mfp-zoom-in">
                        <?php if ($i == 1) {
        ...
        <div class="container margin_60_35">
            <div class="row">
                                        ...
                                        <figure>
                                            ...
                                            <figcaption>
                                                <div class="caption-content">
                                                    <a href="data/hotel/pictures/<?= $picture->big_picture ?>"
                                                        title="<?= $content ?>" data-effect="mfp-zoom-in">
                        ...
                        <form id="hotelYorum" action="" onsubmit="return false" method="POST">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 add_top_20">
                                    <button type="submit" class="btn_1" id="submit-review" onclick="$.otelYorum()">
                                        Senden </button>
                                </div>
                            </div>
                        </form>
                ...
                <aside class="col-lg-4" id="sidebar">
                    <div class="box_detail booking">
                        ...
                        <form id="rez_one" method="POST" onsubmit="return false" action="" class="user-form payment">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" name="dates" id="dates" placeholder="Wann"
                                    autocomplete="off">
                                    ...
                                    <select class="wide" name="room_id">
                                        ...
                                        if ($roomSearch) {
                                            ...
                                            foreach ($roomList as $room) {
                                                ?>
                                                <option value="<?= $room->room_id ?>"><?= kisalt($room->name, 30) ?> - ab
                                                    <?= $room->person_price ?> € p.P.</option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                                </div>
                    ...
                    <div class="alert alert-warning" style="padding: 15px;"> <strong>All Inclusive! </strong> <br>
                        <p style="padding: 0; margin:0;">Flug, Reise und Transfer im Preis enthalten.</p>
                    </div>
                    <hr>
                    <!-- Go to www.addthis.com/dashboard to customize your tools -->
                    <script type="text/javascript"
                        src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5c61e51d87057590"></script>
